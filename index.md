...
##### The graph to the right shows about two weeks og logged data plotted. Notice that there is a gap from 6/6 about 11pm until the morning of  6/8. The esp32 base station had gotton unplugged from usb and was not noticed until over thirty hours later. When the base station was plugged back in the remote clients registered with the names previously assigned. Notice the backPorch sensor has the largest min/max temperature deviations while the basement las the least, and appears preminately the dampest. Dips in pressure are good predictors of increased backporch humidity and rain.
