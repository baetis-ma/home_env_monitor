...
##### The program can handle webpages that are many packets long. The index.html file is sited as embed file in the main/components.mk build file. The program breaks the html filr into 1500 bytes chunks to be sent as separate packets.
